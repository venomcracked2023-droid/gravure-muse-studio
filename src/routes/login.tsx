        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-lg">
          ...
          >
            <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden="true">
              ...
              <path
                fill="#FF3D00"
                d="M6.3 14.7l6.6 4.8C14.6 16 19 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.7 6.5 29.1 4.5 24 4.5 16.3 4.5 9.7 8.7 6.3 14.7z"
              />
              <path
                fill="#4CAF50"
                d="M24 43.5c5 0 9.5-1.9 12.9-5l-6-5.1c-2 1.4-4.4 2.1-6.9 2.1-5.3 0-9.7-3.1-11.3-7.5l-6.5 5C9.5 39.2 16.2 43.5 24 43.5z"
              />
              <path
                fill="#1976D2"
