...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#2a1018" },
      ...
      { property: "og:description", content: "Ngắm ảnh gravure cuộn dọc, mượt và đẹp. Cập nhật album mới mỗi ngày." },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "vi_VN" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "GravureHub — Gravure" },
      { name: "twitter:description", content: "Ngắm ảnh gravure cuộn dọc, mượt và đẹp." },
